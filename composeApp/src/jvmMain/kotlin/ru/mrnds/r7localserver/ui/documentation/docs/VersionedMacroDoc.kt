...
val versionedMacroDoc = EndpointDoc(
    ...
    notes = listOf(
        ...
        "Перед включением истории обновите сервер и оба плагина на всех компьютерах. Старый /macros/sync и /files/write не могут изменять управляемую библиотеку.",
        "Companion только проверяет обновления. Без сохранённого _r7Sync разные версии требуют ручного выбора. После применения сохраните книгу в Р7."
    )
)
